...
{
    /*UART 初始化设置*/
    g_uart1_handle.Instance = USART2;                                       /* USART_UX */
    ...
    HAL_UART_Init(&g_uart1_handle);                                           /* HAL_UART_Init()会使能UART2 */
...
void HAL_UART_MspInit(UART_HandleTypeDef *huart)
{
    ...
    if (huart->Instance == USART2)                            /*  MSP初始化 */
    {
        ...
        HAL_GPIO_Init(GPIOA, &gpio_init_struct);
			  ...
			  gpio_init_struct.Pin = GPIO_PIN_3;               /* 串口发送引脚号 */
